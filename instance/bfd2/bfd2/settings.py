# Django settings for bfd2 project.
...
DATABASES = {
    'default': {
        ...
        'NAME': virtualpath('var', 'db', '$INSTANCE_NAME-dev.db'),                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'bfd2.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bfd2.wsgi.application'
